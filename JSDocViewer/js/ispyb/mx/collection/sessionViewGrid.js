...
SessionViewGrid.prototype._getColumns = function () {
	...
	function renderImagePrefix(value, p, record) {
		...
		if (record.data.dataCollectionId) {
			...
			return "<div style='white-space:normal !important;'><a href='" + _this.contextPath +
			...
			return '<div style="white-space:normal !important;">' + record.data.imagePrefix + '</div>';
		}
	}
