...
var BIOSAXS = {
	...
	start : function(targetId) {
		...
		var _this = this;
		Ext.require([
			'Ext.grid.*', 'Ext.data.*', 'Ext.util.*', 'Ext.state.*', 'Ext.form.*', 'Ext.tab.*', 'Ext.ux.CheckColumn', 'Ext.ux.RowExpander', 'Ext.selection.CheckboxModel', 'Ext.layout.container.Column', 'Ext.ux.grid.FiltersFeature',
			'Ext.selection.CellModel', 'Ext.util.*', 'Ext.form.*', 'Ext.ux.form.MultiSelect', 'Ext.ux.form.ItemSelector', 'Ext.chart.*', 'Ext.Window', 'Ext.fx.target.Sprite', 'Ext.layout.container.Fit', 'Ext.window.MessageBox',
			'Ext.ux.data.PagingMemoryProxy', 'Ext.toolbar.Paging', 'Ext.ux.SlidingPager', 'Ext.form.Panel', 'Ext.ux.form.MultiSelect', 'Ext.ux.form.ItemSelector', 'Ext.ux.ajax.JsonSimlet', 'Ext.ux.ajax.SimManager', 'Ext.tip.QuickTipManager',
			'Ext.layout.*', 'Ext.form.Label', 'Ext.selection.*', 'Ext.tab.Panel', 'Ext.tree.*', 'Ext.ux.LiveSearchGridPanel' ]);
	...
	showQueue : function(targetId) {
		...
		grid.grid.setLoading();
		
		BIOSAXS.proposal.onInitialized.attach(function() {
//			var adapter = new BiosaxsDataAdapter();
//			adapter.onSuccess.attach(function(sender, data){
//				grid.grid.setLoading(false);
//				grid.grid.destroy();
//				grid.getPanel(data).render(targetId);
				/** Update **/
				function updateExperiments() {
					var adapter = new BiosaxsDataAdapter();
					adapter.onSuccess.attach(function(sender, data) {
						grid.grid.setLoading("Updating");
						grid.refresh(data);
						grid.grid.setLoading(false);
					...
					adapter.getCompactAnalysisByProposalId(grid.limit);
