...
SpecimenGrid.prototype.getPanel = function(data) {
	var _this = this;
...
//									if (!_this.experimentColorBased){
//										return BUI.getRectangleColorDIV(BIOSAXS.proposal.macromoleculeColors[macromoleculeId], 10, 10);
//									}
//									else{
