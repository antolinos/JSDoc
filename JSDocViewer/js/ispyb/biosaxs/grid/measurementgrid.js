		...
		if (_this.sortingBtnEnable) {
			var split = Ext.create('Ext.button.Split', {
				...
				menu : new Ext.menu.Menu({
					items : [
					// these will render as dropdown menu items when the arrow
					// is clicked:
					// {text: 'Buffer > Exp. Temp. ASC', handler: function(){
					// alert("Item 1 clicked"); }},
					// {text: 'Buffer > Exp. Temp. DESC', handler: function(){
					// alert("Item 1 clicked"); }},
					// {text: 'Macromolecule > Exp. Temp. DESC', handler:
					// function(){ alert("Item 1 clicked"); }},
					{
