...
BiosaxsDataAdapter.prototype.saveStoichiometry = function(macromoleculeId, macromoleculeMolarityId, ratio, comments) {
	this._doAction("saveStoichiometry", {
		macromoleculeMolarityId : macromoleculeMolarityId,
...
BiosaxsDataAdapter.prototype.getScatteringCurveByFrameIdsList = function(frameIdsList, mergeIdsList, subtractionIds) {
...
BiosaxsDataAdapter.prototype.getProposal = function(sessionId) {
...
BiosaxsDataAdapter.prototype.createShipment = function(shippingId, name, status, comments,
		sendingLabContactId, returnLabContactId, returnCourier, courierAccount, BillingReference,
		dewarAvgCustomsValue, dewarAvgTransportValue) {
	var _this = this;
	$.ajax({
		type : this.type,
